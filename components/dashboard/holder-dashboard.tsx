        ...
        <main className="holder-content" id="dashboard-content">
          ...
          {section === "overview" && <>
            <div className="holder-overview-grid">
              <section className="holder-feature"><div className="broadcast-art" aria-hidden="true"><i /><i /><i /><span>[s]</span></div><div className="feature-content"><span className="holder-badge">THE NEXT CHAPTER</span><h2>Before the premiere.<br />Behind the scenes.</h2><p>Follow the path from the token launch to the first original shows. This is where the network’s progress will come into focus.</p><button className="holder-button" onClick={() => navigate("updates")}>Explore the network plan <ArrowUpRight size={16} /></button></div></section>
